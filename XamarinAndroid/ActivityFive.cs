...
namespace XamarinAndroid.Resources.layout
{
    ...
    public class ActivityFive : Activity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                shared.AddClothesForList(i1.NameClothes, Resource.Drawable.socs, 10, i1.id);
            }
        ...
        private async void Button_Click(object sender, EventArgs e)
        {
            ...
            shared.clothes.Add(new Clothes<int>(cl.NameClothes, Resource.Drawable.socs, cl.idType, cl.id));
